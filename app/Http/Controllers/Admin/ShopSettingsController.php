...
class ShopSettingsController extends Controller
{
    ...
    private function contentData(Request $request): array
    {
        return array_merge($this->shell(
            ...
            quickStats: [
                ['label' => 'Active Slider Items', 'value' => '3', 'note' => '1 slide is scheduled', 'tone' => 'primary'],
                ['label' => 'Legal Pages Live', 'value' => '5/6', 'note' => 'Refund policy in review', 'tone' => 'success'],
            ...
            'sliderItems' => [
                [
                    ...
                    'headline' => 'Fresh drops are now live with limited launch pricing.',
                ...
                [
                    ...
                    'headline' => '48-hour campaign with high-intent product bundles.',
                    'cta' => 'Claim Flash Deals',
                    'url' => '/offers/flash-sale',
                    'schedule' => '23 Feb 2026 - 25 Feb 2026',
                    'priority' => 2,
                    'status' => 'Scheduled',
                ...
                [
                    ...
                    'headline' => 'Highlight free shipping threshold for all regions.',
                ...
                [
                    ...
                    'headline' => 'Drive app installs with app-only coupon messaging.',
                    'cta' => 'Download App',
                    'url' => '/app',
            ...
            'footerBlocks' => [
                [
                    ...
                    'description' => 'Collect subscriber emails with discount incentive in footer.',
                    'enabled' => true,
                ],
                [
                    'id' => 'footer_payment_icons',
                    'label' => 'Payment Method Icons',
                    'description' => 'Show card, mobile banking, and cash-on-delivery indicators.',
                    'enabled' => true,
                ],
                [
                    'id' => 'footer_trust_badges',
                    'label' => 'Trust and Security Badges',
                    'description' => 'Display secure checkout and buyer protection trust chips.',
                    'enabled' => true,
                ],
                [
                    'id' => 'footer_app_links',
                    'label' => 'Mobile App Download Links',
                    'description' => 'Show Play Store and App Store shortcuts in footer.',
                    'enabled' => false,
                ],
                [
                    'id' => 'footer_whatsapp_button',
                    'label' => 'Floating WhatsApp Help',
                    'description' => 'Sticky WhatsApp support button on storefront pages.',
                    'enabled' => true,
                ],
            ],
            'trustSettings' => [
            ...
            'checklist' => [
                'Keep homepage slider copy aligned with active coupon campaigns.',
                'Review Terms, Privacy, and Refund pages every month.',
                'Verify support phone and WhatsApp details before campaign launches.',
                'Keep footer trust badges and payment icons synced with checkout policy.',
                'Validate SEO default meta before publishing new landing pages.',
            ],
        ]);
    }
}
