      ...
      <div class="container contact-container">
        <div class="contact-info">
          ...
          <div class="contact-options">
            <div class="contact-option">
              ...
              <div>
                <h4>নিরাপদ লগইন</h4>
                <p>আপনার তথ্য এনক্রিপটেড চ্যানেলে পাঠানো হয়।</p>
              </div>
            </div>
            <div class="contact-option">
              <div class="co-icon">
        ...
        <div class="contact-form-wrap">
          ...
          <div class="auth-choice" id="authChoice">
            ...
            <path fill="#1976D2" d="M43.61 20.08H42V20H24v8h11.3c-.79 2.24-2.23 4.17-3.83 5.58l.01-.01 6.41 5.42C37.43 38.59 44 34 44 24c0-1.34-.14-2.65-.39-3.92z"></path></svg></span> <span>Continue with Google</span></button>
            
            <button type="button" id="emailAuthBtn" class="btn btn-block auth-option-btn email-auth-btn" aria-label="Continue with Email"><span>Continue with Email</span></button>
          </div>
          @if ($errors->has('login'))
          ...
          @endif
          <form class="contact-form auth-email-form" id="loginForm" action="{{ route('login.submit') }}" method="POST" hidden="" name="loginForm">
            @csrf
            <div class="form-group">
              <label>ইমেইল *</label> <input type="email" name="email" value="{{ old('email') }}" required="">
            </div>
            <div class="form-group">
