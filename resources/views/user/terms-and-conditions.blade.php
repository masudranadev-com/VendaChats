...
@section('title', 'Terms and Conditions | Ametafy')
@section('og_title', 'Terms and Conditions | Ametafy')
@section('og_description', 'Read our Terms and Conditions to understand your rights and responsibilities when using Ametafy services.')
    ...
    <section class="section">
      <div class="container">
        <div class="fd-card">
          ...
          <p>By using Ametafy, you agree to these Terms and Conditions. If you do not agree, please do not use the platform.</p>
          ...
          <p>The platform, software, design, and branding are the property of Ametafy. You may not copy or distribute them without written permission.</p>
